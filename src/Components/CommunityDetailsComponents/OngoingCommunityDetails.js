...
export default function OngoingCommunityDetails(props) {
   ...
   const [image, setImage] = useState(
      <>
         ...
         <img className="mainhouseimg" src={props.ongoingurl[0].ongoinghouses[0].image} onClick={()=>{window.open("/House-1","_self")}}/>
         ...
         <b>Elemntary:</b> Spring Creek ,  <b> Middle:</b>  Deer Creek , <b> High:</b>  Deer Creek , <b> School Dist:</b> Deer Creek<br />
            <div className="descriptiontable">
                <table>
                    <tbody>
            {props.ongoingurl[0].ongoinghouses[0].descriptions.map((datas)=>
