    ...
    <>
      <div className="headermainbar">
        ...
        <div className="anchortags">
          ...
          <Button className="contactus" onClick={handleOpen}>
            {props.fourth}
          </Button>
          <Modal
            open={open}
              ...
              <Card className="card">
                <div className="cardheader">
                  ...
                  <p className="cardtitle">
                    JustSmart Custom Homes
                    <br />
                    <span> Edmond, OK</span>
                  </p>
                </div>

                <CardMedia className="homeimg" component="img" image={House} />
          ...
          <Button className="gallery" onClick={handleGalleryOpen}>
            {props.fifth}
          </Button>
        </div>
        <Modal
