...
export default function HomePage() {
    return (
        <>
            <Header second="Readily Available" third="Completed Proj" fourth="Contact-us" fifth="Gallery" sixth="OurBusinessAssociates" secondid="readilyavailable" thirdid="completedproj" fourthid="contactus" />
            <HomePageSlider />
            <AboutusReview />
            <Footer />
        </>
